...
const inputStyle: React.CSSProperties = {
  width: "100%", background: "var(--sk-deep)", border: "0.5px solid var(--sk-surface)", borderRadius: 6,
  padding: "7px 10px", color: "var(--sk-t1)", fontSize: 12, outline: "none",
};
...
export default function BrandingEditor({ tenantId, superadminKey, initial, notify, onSaved }: Props) {
  ...
  return (
    <div style={{ marginTop: 20, borderTop: "0.5px solid var(--sk-surface)", paddingTop: 16 }}>
      ...
      <div style={{ display: "flex", gap: 16, flexWrap: "wrap", alignItems: "flex-start" }}>
        ...
        <div style={{ width: 150 }}>
          <div
            ...
            style={{
              height: 72, borderRadius: 8, background: "var(--sk-deep)", border: "1px dashed var(--sk-border)",
          ...
          >
            {preview && !removeLogo ? (
              ...
              <span style={{ color: "var(--sk-t3)", fontSize: 11, textAlign: "center" }}>+ Logo client<br />PNG / JPEG / WebP</span>
            )}
          </div>
        ...
        <div style={{ flex: 1, minWidth: 220, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          ...
          <div>
            <label style={{ fontSize: 10, color: "#6b7280", display: "block", marginBottom: 3 }}>Skin (ambiance — l&apos;accent reste ta couleur)</label>
            <select value={skin} onChange={e => setSkin(e.target.value)} style={{ ...inputStyle, cursor: "pointer" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end" }}>
            <button onClick={save} disabled={saving}
              style={{
                background: saving ? "var(--sk-surface)" : "#f5a623", color: saving ? "var(--sk-t3)" : "var(--sk-deep)",
