...
const NOTIF_META: Record<string, { title: string; body: (d: any) => string; url: string; recipient: "admin" | "driver" }> = {
  ...
  expense_approved:  { title: "✅ Dépense validée",      body: (d) => `Votre dépense de ${d.amount} FCFA (${d.category}) a été validée`, url: "/driver", recipient: "driver" },
  expense_rejected:  { title: "❌ Dépense refusée",      body: (d) => `Votre dépense de ${d.amount} FCFA (${d.category}) a été refusée`, url: "/driver", recipient: "driver" },
